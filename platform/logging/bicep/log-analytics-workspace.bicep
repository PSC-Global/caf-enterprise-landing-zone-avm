...
// =============================================================================
// Purpose: Creates the central Log Analytics Workspace for platform telemetry
...
@description('Deployment environment (not used but kept for contract compliance)')
...
@description('Diagnostic storage account resource ID (if enableDiagnostics is true)')
