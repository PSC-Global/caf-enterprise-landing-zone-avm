// ============================================================================
// Policy Assignment Module - Tenant Scope
// ============================================================================
// Description: Reusable wrapper for AVM policy assignment at tenant scope
// Usage: Assign built-in or custom policies/initiatives at the tenant root level
// ============================================================================
...
@description('The location for the policy assignment metadata. Required for tenant-scoped deployments.')
